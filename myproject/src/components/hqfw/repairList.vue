  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="repairsList" stripe border max-height="500px">
        ...
        <el-table-column label="报修日期" prop="bxdate" width="100px"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    oneQuest() {
      var _this = this;
      this.$http
        .post("http://localhost/repairReport/search", this.queryInfo)
    ...
    async userStateChanged(userInfo) {
      ...
      // 根据id值发起请求改变开关状态
      this.$http
        .post("http://localhost/repairReport/onoff", {
          id: userInfo.id,
    ...
    async removeUserById(id) {
      ...
      // 根据id值发起请求删除该事件
      this.$http
        .post("http://localhost/repairReport/del", {
          id: id
        })
        .then(function(response) {
          console.log(response.data);
