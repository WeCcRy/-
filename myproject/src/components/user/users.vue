  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" stripe border height="420">
        ...
        <el-table-column label="工号" prop="uname"></el-table-column>
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip effect="dark" content="删除" placement="top" :enterable="false">
              <el-button
                ...
                icon="el-icon-delete"
                size="mini"
                @click="removeUserById(scope.row.uname)"
              ></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      ...
      <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
        ...
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="80px">
          ...
          <el-form-item label="角色" prop="roler">
            <el-select v-model="addForm.roler" placeholder="请选择角色">
...
export default {
    ...
    return {
      ...
      addFormRules: {
        userId:[
          ...
          {min:11,max:11,message:"工号为11位",trigger: "blur"}
        ],
        userName: [
        ...
        roler: [{ required: true, message: "请选择用户角色", trigger: "blur" }]
      },
      // 修改用户的表单数据
      editForm: {
        uname: "",
  ...
  methods: {
    ...
    oneQuest() {
      var _this = this;
      this.$http
        .post("http://localhost/yhqx/search", this.queryInfo)
    ...
    addUser() {
      ...
      this.$refs.addFormRef.validate(valid => {
        ...
        // 如果预校验成功则发起添加用户请求
        this.$http
        .post("http://localhost/yhqx/add", this.addForm)
        .then(function(response) {
          console.log(response.data);
          if (response.data.code == 200) {
            _this.$notify({
    ...
    editUserInfo() {
      ...
      this.$refs.editFormRef.validate(valid => {
        ...
        // 如果预校验成功则发起修改用户信息的请求
        this.$http
        .post("http://localhost/yhqx/edit", this.editForm)
        .then(function(response) {
          console.log(response.data);
          if (response.data.code == 200) {
            _this.$notify({
    ...
    async removeUserById(uname) {
      ...
      this.$http
        .post("http://localhost/yhqx/del", {uname})
        .then(function(response) {
          console.log(response.data);
          if (response.data.code == 200) {
            _this.$notify({
